...
# intercepted message:
correct_ct = bytes.fromhex('2e9f47e4969aec3bb655ee2c168a5feff4e51831191cbf59303602a371ff769e321842dfb1f5d68e936ec3c63a26d7a3bdf88b03369efd565aa9f90d7d267192b84d88e47f2176015a451920cc71033e65da77428139221aa60a458e045f84c3')

# secret plaintext message with removed padding:
correct_pt = bytes.fromhex('54686973206d757374206d6174636820776861746576657220776173206465637279707465642c206f74686572776973652049207468726f7720616e206572726f722e')
...
def decrypt_and_check(msg: bytes):
    ...
    if (dt_unpad == correct_pt): return 200
